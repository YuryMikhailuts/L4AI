...
namespace l4ai::algs {
	 ...
	 *
	 * При этом, поскольку длинна входного набора данных можнт не совпадать с количеством строк матрицы весов, данный вид перцептрона поддарживает возможность удлинения столбцов матрицы, путём дописывания некоторого количества нулей в начале столбца следующим образом:
	 *
